...
date: 2025-09-26 16:43
last_modified_at: "2025-09-25 10:19:57 +0800"
category: note
---
...
![个人身份和公司身份收款差异]({{ site.postimg}}/duns-money.png)
...
![邓白氏编码的三个申请入口]({{site.postimg }}/duns-entry.jpg)

点击之后会进入 apple 的网页，需要先点击链接到查询页面里面查询，查不到的时候才会出来申请入口。

![苹果开发者duns申请入口]({{ site.postimg }}/duns-apple-entry.png)
